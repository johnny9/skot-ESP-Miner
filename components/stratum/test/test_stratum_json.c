...
TEST_CASE("Parse stratum notify params", "[mining.notify]")
{
    ...
    TEST_ASSERT_EQUAL_UINT32(0x1705c739, stratum_api_v1_message.mining_notification.nbits);
    TEST_ASSERT_EQUAL_UINT32(0x64495522, stratum_api_v1_message.mining_notification.ntime);
    TEST_ASSERT_EQUAL(12, stratum_api_v1_message.mining_notification.merkle_path_count);
    TEST_ASSERT_EQUAL(JOB_TYPE_V1, stratum_api_v1_message.mining_notification.type);
}
